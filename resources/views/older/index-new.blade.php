        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                <div class="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                    Official Announcement of graduation 
                    <span class="font-bold text-blue-600">SMK Negeri 1 Cijati 2026</span>
                </div>
            </div>
            <div class="text-center">
                ...
                <p class="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
                    Portal resmi sekolah untuk melihat hasil kelulusan siswa secara cepat, aman, dan transparan. 
                    Silakan ketikan NIS yang telah diberikan untuk mengakses informasi kelulusan.
                </p>
